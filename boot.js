...
(function () {
  ...
  var files = [
    ...
    ['rules.js?v=3.3.1', '게임 규칙 준비 중…'],
    ['shared/world.js?v=3.3.1', '공유 전장 준비 중…'],
    ['loot-visuals.js?v=3.3.1', '아이템 준비 중…'],
    ['controls.js?v=3.3.1', '모바일 조작 준비 중…'],
    ['online.js?v=3.3.1', '친구와 플레이 준비 중…'],
    ['environment.js?v=3.3.1', '전장 재질과 조명 준비 중…'],
    ['viewmodel.js?v=3.3.1', '손과 무기 모델 준비 중…'],
    ['game.js?v=3.3.1', '전장 생성 중…']
  ];
  function load(index) {
