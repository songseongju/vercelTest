...
for(const file of ['index.html','style.css','game.js','environment.js','viewmodel.js','rules.js','controls.js','loot-visuals.js','boot.js','online.js','diagnostics.html','star-dash.html'])fs.copyFileSync(path.join(root,file),path.join(out,file));
